...
@section('title', 'Siantik - Edit Tahun Soal')
        ...
        <div class="page-title d-flex align-items-center flex-wrap me-3 mb-5 mb-lg-0">
            ...
            <ul class="breadcrumb breadcrumb-separatorless fw-bold fs-7 my-1">
                <li class="breadcrumb-item text-muted">
                    <a href="{{ route('soal.index') }}" class="text-muted text-hover-primary">Ubah Soal</a>
                </li>
    ...
    <div id="kt_content_container" class="container-fluid px-10">
        <div class="card">
            ...
            <div class="card-body">
                ...
                <form method="POST" action="{{ route('soal.update', $tahunSoal->id) }}">
                    @csrf
                    @method('PUT')
                    ...
                    <div class="mb-5">
                        ...
                        <input type="number" name="tahun" class="form-control form-control-solid" 
                            value="{{ old('tahun', $tahunSoal->tahun) }}" required>
                    </div>

                    <div class="mb-5">
                        <label class="form-label">Deskripsi</label>
                        <textarea name="deskripsi" class="form-control form-control-solid" rows="4">{{ old('deskripsi', $tahunSoal->deskripsi) }}</textarea>
                    </div>
