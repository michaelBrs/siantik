...
@section('container')
            ...
            <div class="card">
                    ...
                    <div class="card-toolbar flex-column w-100">
                        <div class="d-flex justify-content-between align-items-center w-100 mb-3">
                            <div class="card-title">
                                <h3 class="mb-0">KELOLA TAHAPAN FORMULIR PENILAIAN</h3>
                            </div>
                ...
                <div class="card-body py-4">
                    ...
                    <div class="table-responsive">
                        <table class="table table-striped table-rounded border border-gray-300 table-row-bordered table-row-gray-300 gy-7 gs-7" id="kt_table_formPenilaianTahapan">
                            <thead>
    ...
    <script>
        $(document).ready(function () {
            const table = $('#kt_table_formPenilaianTahapan').DataTable({
                processing: true,
                serverSide: true,
                ajax: "{{ route('jadwal-tahapan.formPenilaian') }}",
                columns: [
